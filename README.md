...
### Памятка
***
* [Памятка курса](src/main/description/PatterMM.md)
***
### Содержание
***
* [Парадигмы программирования](#парадигмы-программирования)
* [О шаблонах проектирования](#о-шаблонах-проектирования)
...
* Их распространенность с одной стороны - привилегия, с другой - ответственность:
  * Привилегия - шаблоны проектирования позволяют решать сложные задачи более эффективно, чем конкуренты; 
  * Ответственность - шаблоны проектирования нужно различать по способам применения к конкретным проблемам; 
...
организацией элементов, разделением ответственности между компонентами, 
...
## Про тестирование
* Код - ответственность разработчика. Код, отражение того, насколько разработчик профессионален. 
...
* Эту ответственность мы будем рассматривать [отдельно](src/test/java/org/nikitinia/README.md);
...
* Если: 
  ...
  * Будем рады письмам от Вас - **in86@inbox.ru**;