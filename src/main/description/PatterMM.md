...
## Применимость
* Когда говорят о шаблонах проектирования, то имеет в виду преимущественно Gof шаблоны; 
* Они сконцентрированы на решении конкретных практических задач постоянно возникающих 
...
## SOLID
* Что такое шаблоны проектирования - разные подходы к решению типовых задач программирования, 
которые направлены на то, чтобы создаваемый код соответсвовал принципам SOLID:
