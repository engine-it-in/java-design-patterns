 ...
 * I - Разделение интерфейсов -> Работаем с конкретным интерфейсом и только с ним, не перегружая приведенный итератор;
 * D - Класс зависит от абстракций и не зависит ни от чего конкретного;
 */
