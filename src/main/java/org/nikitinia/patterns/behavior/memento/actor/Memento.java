...
/**
 * Что -> Класс снимок, реализующий логику работы с объектом. В нашем случае мы пользуемся документами;
 * Для чего -> В классе снимке мы используем целевой объект и реализуем логику работы со снимками.
