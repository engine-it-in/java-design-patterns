 ...
 * Это классический профиль абстрактного класса, который описывает общее поведение, наследуемое и переопределяемое в своих наследниках;
 * Для чего -> Унификация общей логики, которой должны подчиняться все реализаторы состояния;
 * Реализация -> Абстрактный класс;
 * В чем выгода -> Инкапсуляция общей логики в единый программный компонент;
 */
@Getter
