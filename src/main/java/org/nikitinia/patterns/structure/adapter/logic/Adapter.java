 ...
 * Что -> Класс адаптер, наследующий логику конкретной работы и
 переопределяющий требуемый для нас интерфейс;
 * Для чего -> Наследует компоненты, логику которых надо адаптировать;
 * Реализация -> Класс с конкретными действиями, имплементирующий рабочую сигнатуру;
 * Ценность -> Рабочая логика, реализуемая через этот класс позволит просто менять
